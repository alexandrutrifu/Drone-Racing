...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    GLint material_kd_location = glGetUniformLocation(shader->program, "material_kd");
    glUniform1f(material_kd_location, materialKd);

    GLint material_ks_location = glGetUniformLocation(shader->program, "material_ks");
    glUniform1f(material_ks_location, materialKs);

    GLint material_shininess_location = glGetUniformLocation(shader->program, "material_shininess");
    glUniform1i(material_shininess_location, materialShininess);
